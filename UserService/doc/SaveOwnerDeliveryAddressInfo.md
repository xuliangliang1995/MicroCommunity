...
**1\. 保存业主收货地址**
###### 接口功能
> API服务做保存业主收货地址时调用该接口

###### URL
> [http://user-service/ownerDeliveryAddressApi/service](http://user-service/ownerDeliveryAddressApi/service)
...
###### 举例
> 地址：[http://user-service/ownerDeliveryAddressApi/service](http://user-service/ownerDeliveryAddressApi/service)
