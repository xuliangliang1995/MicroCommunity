...
**1\. 修改业主收货地址**
###### 接口功能
> API服务做修改业主收货地址时调用该接口

###### URL
> [http://ownerDeliveryAddress-service/ownerDeliveryAddressApi/service](http://ownerDeliveryAddress-service/ownerDeliveryAddressApi/service)
...
|datas|businessOwnerDeliveryAddressInfo|1|Object|-|小区成员|小区成员|
|businessOwnerDeliveryAddressInfo|companyFloor|1|String|30|-|-|
|businessOwnerDeliveryAddressInfo|companyName|1|String|30|-|-|
|businessOwnerDeliveryAddressInfo|ownerId|1|String|30|-|-|
|businessOwnerDeliveryAddressInfo|userId|1|String|30|-|-|
|businessOwnerDeliveryAddressInfo|addressId|1|String|30|-|-|
|businessOwnerDeliveryAddressInfo|memberId|1|String|30|-|-|
...
###### 举例
> 地址：[http://ownerDeliveryAddress-service/ownerDeliveryAddressApi/service](http://ownerDeliveryAddress-service/ownerDeliveryAddressApi/service)
