...
###### URL
> [http://commodityIntro-service/commodityIntroApi/service](http://commodityIntro-service/commodityIntroApi/service)
...
|datas|businessCommodityIntroInfo|1|Object|-|小区成员|小区成员|
|businessCommodityIntroInfo|intro|1|String|30|-|-|
|businessCommodityIntroInfo|remark|1|String|30|-|-|
|businessCommodityIntroInfo|commodityId|1|String|30|-|-|
|businessCommodityIntroInfo|introId|1|String|30|-|-|
|businessCommodityIntroInfo|userId|1|String|30|-|-|
...
###### 举例
> 地址：[http://commodityIntro-service/commodityIntroApi/service](http://commodityIntro-service/commodityIntroApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "600200010001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessCommodityIntroInfo": {
                "intro":"填写具体值",
        "remark":"填写具体值",
        "commodityId":"填写具体值",
        "introId":"填写具体值",
