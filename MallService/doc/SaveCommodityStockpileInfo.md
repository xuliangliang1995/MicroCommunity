...
###### URL
> [http://commodityStockpile-service/commodityStockpileApi/service](http://commodityStockpile-service/commodityStockpileApi/service)
...
|datas|businessCommodityStockpileInfo|1|Object|-|小区成员|小区成员|
|businessCommodityStockpileInfo|amount|1|String|30|-|-|
|businessCommodityStockpileInfo|stockpileId|1|String|30|-|-|
|businessCommodityStockpileInfo|remark|1|String|30|-|-|
|businessCommodityStockpileInfo|commodityId|1|String|30|-|-|
|businessCommodityStockpileInfo|version|1|String|30|-|-|
|businessCommodityStockpileInfo|userId|1|String|30|-|-|
...
###### 举例
> 地址：[http://commodityStockpile-service/commodityStockpileApi/service](http://commodityStockpile-service/commodityStockpileApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "600300030001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessCommodityStockpileInfo": {
                "amount":"填写具体值",
        "stockpileId":"填写具体值",
        "remark":"填写具体值",
        "commodityId":"填写具体值",
