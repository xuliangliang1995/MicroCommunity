...
/**
 * @author xuliangliang
 * @Classname MallServiceSMOImpl
 * @Description TODO
 * @Date 2020/3/23 21:13
 * @blame Java Team
 */
@Service("mallServiceSMOImpl")
@Transactional
public class MallServiceSMOImpl extends BaseServiceSMO implements IMallServiceSMO {

    private  static Logger logger = LoggerFactory.getLogger(MallServiceSMOImpl.class);
    ...
    public JSONObject service(BusinessServiceDataFlow businessServiceDataFlow) throws SMOException {
        try {
            ...
            Assert.notEmpty(businessServiceDataFlow.getResJson(), "商城服务[" + businessServiceDataFlow.getCurrentBusiness().getServiceCode() + "]没有返回内容");
        } catch (Exception e) {
            logger.error("商城信息处理异常", e);
            throw new SMOException(ResponseConstant.RESULT_PARAM_ERROR, "商城信息处理异常" + e.getMessage());
        } finally {
