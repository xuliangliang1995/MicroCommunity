 ...
 */
@Java110Listener("deleteCommodityStockpileInfoListener")
@Transactional
public class DeleteCommodityStockpileInfoListener extends AbstractCommodityStockpileBusinessServiceDataFlowListener {

    private final static Logger logger = LoggerFactory.getLogger(DeleteCommodityStockpileInfoListener.class);
    @Autowired
    ICommodityStockpileServiceDao commodityStockpileServiceDaoImpl;
    ...
    public String getBusinessTypeCd() {
        return BusinessTypeConstant.BUSINESS_TYPE_DELETE_COMMODITY_STOCKPILE;
    }
    ...
    protected void doBusinessToInstance(DataFlowContext dataFlowContext, Business business) {
        ...
        if( businessCommodityStockpileInfos != null && businessCommodityStockpileInfos.size() >0) {
            for (int _commodityStockpileIndex = 0; _commodityStockpileIndex < businessCommodityStockpileInfos.size();_commodityStockpileIndex++) {
                ...
                flushBusinessCommodityStockpileInfo(businessCommodityStockpileInfo,StatusConstant.STATUS_CD_INVALID);
