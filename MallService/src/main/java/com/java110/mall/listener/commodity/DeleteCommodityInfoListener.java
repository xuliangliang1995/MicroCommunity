 ...
 */
@Java110Listener("deleteCommodityInfoListener")
@Transactional
public class DeleteCommodityInfoListener extends AbstractCommodityBusinessServiceDataFlowListener {

    private final static Logger logger = LoggerFactory.getLogger(DeleteCommodityInfoListener.class);
    @Autowired
    ICommodityServiceDao commodityServiceDaoImpl;
    ...
    public String getBusinessTypeCd() {
        return BusinessTypeConstant.BUSINESS_TYPE_DELETE_COMMODITY;
    }
    ...
    protected void doBusinessToInstance(DataFlowContext dataFlowContext, Business business) {
        ...
        if( businessCommodityInfos != null && businessCommodityInfos.size() >0) {
            for (int _commodityIndex = 0; _commodityIndex < businessCommodityInfos.size();_commodityIndex++) {
                ...
                flushBusinessCommodityInfo(businessCommodityInfo,StatusConstant.STATUS_CD_INVALID);
