...
/**
 * @author xuliangliang
 * @Classname MallServiceKafka
 * @Description TODO
 * @Date 2020/3/23 21:19
 * @blame Java Team
 */
public class MallServiceKafka extends BaseController {

    private final static Logger logger = LoggerFactory.getLogger(MallServiceKafka.class);

    @Autowired
    private IMallServiceSMO mallServiceSMOImpl;

    @KafkaListener(topics = {"mallServiceTopic"})
