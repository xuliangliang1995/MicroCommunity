package com.java110.mall.api;

import com.alibaba.fastjson.JSONObject;
import com.java110.core.base.controller.BaseController;
import com.java110.core.context.BusinessServiceDataFlow;
import com.java110.core.factory.DataTransactionFactory;
import com.java110.mall.smo.IMallServiceSMO;
 ...
 */
@RestController
public class MallApi extends BaseController {
    private static Logger logger = LoggerFactory.getLogger(MallApi.class);

    @Autowired
    IMallServiceSMO mallServiceSMOImpl;
     ...
     * @return
     */
    @RequestMapping(path = "/mallApi/service", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(path = "/mallApi/service", method = RequestMethod.POST)
    public String servicePost(@RequestBody String orderInfo, HttpServletRequest request) {
        ...
        try {
            ...
            responseJson = mallServiceSMOImpl.service(businessServiceDataFlow);
    ...
    public IMallServiceSMO getMallServiceSMOImpl() {
        return mallServiceSMOImpl;
    }

    public void setMallServiceSMOImpl(IMallServiceSMO mallServiceSMOImpl) {
        this.mallServiceSMOImpl = mallServiceSMOImpl;
    }
}
